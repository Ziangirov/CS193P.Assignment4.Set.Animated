...
class SetCardView: UIView {
    ...
    var number: SetCard.Number = .two { didSet { setNeedsDisplay(); setNeedsLayout() }}
    var symbol: SetCard.Symbol = .square { didSet { setNeedsDisplay(); setNeedsLayout() }}
    var color: SetCard.Color = .red { didSet { setNeedsDisplay(); setNeedsLayout() }}
    var shade: SetCard.Shade = .striped { didSet { setNeedsDisplay(); setNeedsLayout() }}
...
private extension SetCard.Symbol {
...
private extension SetCard.Shade {
    var shadingPath: (_ path: UIBezierPath,_ inRect: CGRect) -> () {
        ...
        case .outlined:
            return {
                _ = $1
                $0.lineWidth = SetCardView.Constants.borderWidth
                $0.stroke()
            }
        }
    }
...
private extension SetCard.Number {
...
private extension SetCard.Color {
...
private extension SetCardView.SelectionState {
