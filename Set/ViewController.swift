...
class ViewController: UIViewController, UIDynamicAnimatorDelegate {
    ...
    private var dealCardViews: [CardView] {
    ...
    private func updateLabels() {
        ...
        if game.isFinished() {
            ...
            case 0:
                scoreLabel.layer.borderWidth = CardView.Constants.borderWidth
                scoreLabel.layer.borderColor = UIColor.orange.cgColor
                
                gameView.subviews.forEach { $0.removeFromSuperview() }
            default:
                dealCardsButton.layer.borderWidth = CardView.Constants.borderWidth
    ...
    private func updateViewFromModel() {
        ...
        if gameView.cardViews.count > Game.CardsCountAt.start {
            gameView.removeCardViews(matchedCardViews)
        }
    }
